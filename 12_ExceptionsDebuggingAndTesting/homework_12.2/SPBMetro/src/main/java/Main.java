...
public class Main {
    private static Logger logger, logger1, logger2, logger3;
    ...
    public static void main(String[] args) {
        ...
        logger1 = LogManager.getLogger("search");
        logger2 = LogManager.getLogger("input_errors");
        logger3 = LogManager.getLogger("exceptions");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                logger1.info("ввод станции " + line);
                return station;
            }
